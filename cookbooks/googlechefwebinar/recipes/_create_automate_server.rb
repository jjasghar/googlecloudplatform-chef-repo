...
gcompute_disk 'instance-test-os-2' do
  action :create
...
gcompute_address 'instance-test-ip-2' do
  action :create
  region 'us-west1'
  project myproject
  credential 'mycred'
  ...
  metadata ({
              items: [
                { key: 'startup-script-url',
                  value: 'https://storage.googleapis.com/jj-test-kitchen/automate_bootstrap.sh'
                }
              ]
            })
  tags ({
